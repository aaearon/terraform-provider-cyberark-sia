...
// Note: The helper functions (buildCompositeID, parseCompositeID, determineWorkspaceType)
// are defined in internal/provider/policy_database_assignment_resource.go
